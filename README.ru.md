...
-   Система реактивных частиц с эффектами попадания, которые отображают обратную связь на основе:
    ...
    -   Часть тела, пораженная выстрелом (выстрел в голову, в тело)
...
-   Включить/выключить пулы при смерти
...
-   [x] Создавайте лучшие текстуры ран
...
-   Slowmo / камера убийства / Kill cam updates:
    ...
    -   Улучшена обработка сброса камеры/временной шкалы при перезагрузке игры в середине события.
