...
-   Исправлены проблемы с синхронизацией, когда NPC умирал до завершения обратного вызова on_hit. Если вы заметили пропущенные пулы или время пули после убийства с одного удара, увеличьте «задержку» в MCM> «Кровавые стены»> «Общие».
